...
public class C08_Split {
    public static void main(String[] args) {
        //verilen bir cumlede istenen harfin kac defa kullanıldıgını yazan bir method olusturun
    ...
    private static void harfKacKereKullanılmıs(String cumle, String harf) {
        ...
        System.out.println("Aradıgınız "+harf+ " verilen cumlede " +sayac+" adet kullanılmıstır");
