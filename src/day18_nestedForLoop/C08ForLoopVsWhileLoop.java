...
public class C08ForLoopVsWhileLoop {
    public static void main(String[] args) {
        ...
        System.out.println(toplam);
        //baslangıc bıtıs ve degisim degerleri net olan durumlarda for loop daha avantajlıdır
        //ama adım sayisi belli olmayan durumlarda while loop daha avantajlıdır
